layui.config({
    ...
    layui.droptree("/UserSession/QueryModuleList?isMustEnable=false", "#ParentName", "#ParentId", false);
    ...
    //左边树状机构列表
    var ztree = function () {
        var url = '/UserSession/QueryModuleList?isMustEnable=false';
        var zTreeObj;
        var setting = {
        ...
        var show = function (data) {
            ...
            var index = layer.open({
                ...
                success: function() {
                    ...
                    $("input:checkbox[name='IsEnable']").prop("checked", data.IsEnable);
                    form.render();
                },
                end: mainList
            });
    ...
    var active = {
        ...
        btnEnable: function () {
            ...
            layer.confirm('您确定要启用这些模块吗？',
                function (index) {
                    var loadIndex = layer.load();
                    $.post("/moduleManager/SetEnableStatus",
                        {
