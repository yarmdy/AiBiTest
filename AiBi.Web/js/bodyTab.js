...
layui.define(["element","jquery"],function(exports){
	...
	Tab.prototype.render = function() {
        ...
        $.get(url,
            function(data) {
                ...
                if ($(".navBar").html() == '') {
                    var _this = this;
                    $(".navBar").html(BuildLeftNavBar(data)).height($(window).height() - 192);
                    element.init(); //初始化页面元素
                    $(window).resize(function() {
                        $(".navBar").height($(window).height() - 192);
                    });
				}
            },
            "json");
	...
	Tab.prototype.tabAdd2 = function(_this){
