...
layui.define(['jquery', 'layer'], function (exports) {
    ...
    var onClick = function (e, treeId, treeNode) {
        ...
        if (inst.config.OnAfterClick != undefined &&
            inst.config.OnAfterClick != null) {
            inst.config.OnAfterClick();
        }
    ...
    Class.prototype.render = function () {
        ...
        var setting = {
            ...
            check: {
                ...
                chkStyle: "checkbox",
                chkboxType: { "Y": that.config.chkboxTypeY, "N": that.config.chkboxTypeN } //去掉勾选时级联
            },
            data: {
                key: {
    ...
    exports('droptreeNew', function (url, name, id, selectedMulti, onAfterClick, chkboxTypeY, chkboxTypeN) {
        if (chkboxTypeY == undefined ||
            chkboxTypeY == null) {
            chkboxTypeY = "";
        }

        if (chkboxTypeN == undefined ||
            chkboxTypeN == null) {
            chkboxTypeN = "";
        }
        ...
        var options = {
            ...
            chkboxTypeY: chkboxTypeY,
            chkboxTypeN: chkboxTypeN
        }
